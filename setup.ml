...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1e41a93d50fec7c4b38a357be26c78fb) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Vnetif"; "Basic_backend"; "Delayed_backend"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mirage-vnetif";
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\249.\016B\014\173\128\231\156\184v\245\252\rS\173";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;

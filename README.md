...
An example of a unikernel that communicates with itself over `Vnetif` can be seen [here](https://github.com/MagnusS/mirage-vnetif/blob/master/examples/unikernel.ml). The example can be compiled for Unix and Xen and does not need access to a real network interface.
